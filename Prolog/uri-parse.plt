...
test(schema4) :- not(uri_parse("htt:p://google.com", uri(_, _, _, _, _, _, _))).
...
test(userinfo4) :- not(uri_parse("http://user@info@host", uri(_, _, _, _, _, _, _))).
test(userinfo5) :- not(uri_parse("http://userin:fo@host", uri(_, _, _, _, _, _, _))).
test(userinfo6) :- not(uri_parse("http://userin/fo@host", uri(_, _, _, _, _, _, _))).
test(userinfo7) :- not(uri_parse("http://userin?fo@host", uri(_, _, _, _, _, _, _))).
test(userinfo8) :- not(uri_parse("http://userin#fo@host", uri(_, _, _, _, _, _, _))).
...
test(host7) :- not(uri_parse("scheme://userinfo@ho?st:123", uri(_, _, _, _, _, _, _))).
test(host8) :- not(uri_parse("scheme://userinfo@ho@st:123", uri(_, _, _, _, _, _, _))).
test(host9) :- not(uri_parse("scheme://userinfo@ho:st:123", uri(_, _, _, _, _, _, _))).
test(host10) :- not(uri_parse("scheme://userinfo@ho/st:123", uri(_, _, _, _, _, _, _))).
test(host11) :- not(uri_parse("scheme://userinfo@ho#st:123", uri(_, _, _, _, _, _, _))).
...
test(port3) :- not(uri_parse("scheme://host:1_23/path", uri(_, _, _, _, _, _, _))).
test(port4) :- not(uri_parse("scheme://host:1a23/path", uri(_, _, _, _, _, _, _))).
