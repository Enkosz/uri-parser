...
test(userinfo_9) :- \+(uri_parse("s://@host", _)).
...
test(mailto4) :- uri_parse("mailto:userinfo@host.com", uri('mailto', 'userinfo', 'host.com', [], [], [], [])).
test(mailto5) :- uri_parse("mailto:user.info",uri('mailto', 'user.info', [], [], [], [], [])).
